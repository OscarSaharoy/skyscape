...
const ozoneScatteringCoeffs    = new THREE.Vector4(0.00, 0.00, 0.00, 0.00).multiplyScalar(1e-6);
const ozoneAbsorptionCoeffs    = new THREE.Vector4(0.68, 1.88, 0.08, 0.00).multiplyScalar(1e-6);
